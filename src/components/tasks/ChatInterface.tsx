  ...
  const handleCreateTask = async (taskData: Partial<Task>) => {
    ...
    try {
      ...
      const confirmationMessage: Message = {
        ...
        role: 'assistant',
        content: `✅ ¡He creado la tarea "${newTask.title}" correctamente! ¿Necesitas algo más?`,
        timestamp: new Date(),
      };
  ...
  return (
    <div className="flex flex-col h-full bg-background dark:bg-background-paper">
      <div className="flex items-center gap-2 border-b border-border dark:border-[#28282F] p-4 flex-shrink-0">
        ...
        <div>
          <h2 className="text-sm font-medium text-foreground">Asistente IA</h2>
          ...
          {messages.length === 0 && (
            <div className="flex flex-col items-center justify-center h-full text-center text-muted-foreground">
              ...
              <p className="text-sm max-w-md">
                Puedo ayudarte a crear tareas de forma natural. Por ejemplo, escribe:
